...
export function findByCartId(cartId: string): Cart {
  return {
    id: cartId,
...
export function addLine(cartId: string, productId: string): Cart {
...
export function countItems(cartId: string): number {
